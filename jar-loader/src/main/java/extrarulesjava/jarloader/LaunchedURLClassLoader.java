...
import extrarulesjava.jarloader.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
	...
	protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
		if (name.startsWith("extrarulesjava.jarloader.jarmode.")) {
			try {
	...
	private void clearCache(URLConnection connection) throws IOException {
		...
		if (jarFile instanceof extrarulesjava.jarloader.jar.JarFile) {
			((extrarulesjava.jarloader.jar.JarFile) jarFile).clearCache();
		}
	}
