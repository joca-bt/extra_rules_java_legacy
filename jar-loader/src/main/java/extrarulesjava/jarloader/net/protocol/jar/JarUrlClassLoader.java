...
import extrarulesjava.jarloader.jar.NestedJarFile;
import extrarulesjava.jarloader.launch.LaunchedClassLoader;
...
public abstract class JarUrlClassLoader extends URLClassLoader {
	...
	public void clearCache() {
		Handler.clearCache();
		extrarulesjava.jarloader.net.protocol.nested.Handler.clearCache();
		try {
			clearJarFiles();
		}
		catch (IOException ex) {
