...
import extrarulesjava.jarloader.data.RandomAccessData;
import extrarulesjava.jarloader.data.RandomAccessDataFile;
...
public class JarFile extends AbstractJarFile implements Iterable<java.util.jar.JarEntry> {
	...
	private static final String HANDLERS_PACKAGE = "extrarulesjava.jarloader";
