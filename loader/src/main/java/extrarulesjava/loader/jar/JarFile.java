...
package extrarulesjava.loader.jar;
...
import extrarulesjava.loader.data.RandomAccessData;
import extrarulesjava.loader.data.RandomAccessDataFile;
...
public class JarFile extends AbstractJarFile implements Iterable<java.util.jar.JarEntry> {
	...
	private static final String HANDLERS_PACKAGE = "extrarulesjava.loader";
